...
`;
  ...
  const userRepoInterface = `import { User, CreateUserDTO, UpdateUserDTO } from '../entities/User';
...
`;
  ...
  // Create User service
  const userService = `import { IUserRepository } from '../repositories/IUserRepository';
